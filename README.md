 ...
 <thead>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="border: 1px solid #ddd;">Eu como novo vendedor quero escolher um plano para assinar.</td>
            <td style="border: 1px solid #ddd;">Média</td>
            <td style="border: 1px solid #ddd;">13</td>
            <td style="border: 1px solid #ddd;">2</td>
        </tr>
        <tr>
            <td style="border: 1px solid #ddd;">RF8</td>
            <td style="border: 1px solid #ddd;">Eu como novo vendedor quero cadastrar meus dados.</td>
            <td style="border: 1px solid #ddd;">Média</td>
            <td style="border: 1px solid #ddd;">8</td>
            <td style="border: 1px solid #ddd;">2</td>
        </tr>
        <tr>
            <td style="border: 1px solid #ddd;">RF9</td>
            <td style="border: 1px solid #ddd;">Eu como novo vendedor do plano iniciante quero poder ver os patrocínios disponíveis.</td>
            <td style="border: 1px solid #ddd;">Média</td>
            <td style="border: 1px solid #ddd;">8</td>
            <td style="border: 1px solid #ddd;">2</td>
        </tr>
        <tr>
            <td style="border: 1px solid #ddd;">RF10</td>
            <td style="border: 1px solid #ddd;">Eu como uma nova empresa patrocinadora quero escolher um plano e me cadastrar.</td>
            <td style="border: 1px solid #ddd;">Média</td>
            <td style="border: 1px solid #ddd;">8</td>
            <td style="border: 1px solid #ddd;">2</td>
        </tr>
        <tr>
            <td style="border: 1px solid #ddd;">RF11</td>
            <td style="border: 1px solid #ddd;">Eu como uma nova empresa patrocinadora quero cadastrar meus dados.</td>
            <td style="border: 1px solid #ddd;">Média</td>
            <td style="border: 1px solid #ddd;">13</td>
            <td style="border: 1px solid #ddd;">2</td>
        </tr>
        <tr>
            <td style="border: 1px solid #ddd;">RF12</td>
            <td style="border: 1px solid #ddd;">Eu como uma nova empresa patrocinadora quero poder escolher o perfil dos vendedores que quero patrocinar.</td>
            <td style="border: 1px solid #ddd;">Média</td>
            <td style="border: 1px solid #ddd;">13</td>
            <td style="border: 1px solid #ddd;">2</td>
        </tr>
        <tr>
            <td style="border: 1px solid #ddd;">RF13</td>
            <td style="border: 1px solid #ddd;">Eu como usuário comum quero poder filtrar os dados do impacto da empresa por data.</td>
            <td style="border: 1px solid #ddd;">Média</td>
            <td style="border: 1px solid #ddd;">21</td>
            <td style="border: 1px solid #ddd;">2</td>
        </tr>        
